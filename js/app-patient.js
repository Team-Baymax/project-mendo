...
},{"./FoodJournalView":66,"./LeapGesture":68,"./PlanScreenView":70,"./SideNavViewPatient":73,"./TopBarViewPatient":79,"./WidgetCollection":82,"./WidgetModel":83,"./WidgetView":85,"./models/PatientModel":86,"./models/TimelineCollection":87,"backbone":2,"eventemitter2":4,"socket.io-client":13}],2:[function(require,module,exports){
//     Backbone.js 1.1.2
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"plan-screen\">\n  <div class=\"timeline-holder\">\n    <div class=\"regimen-overview\">\n      <!-- content added later -->\n    </div>\n    <div class=\"date\">\n      <h1>Today</h1>\n      <p>May 2, 2015</p>\n    </div>\n    <div class=\"modules-holder\">\n      <!-- Modules are populated -->\n    </div>\n  </div>\n</div>";
  });

},{"hbsfy/runtime":12}],70:[function(require,module,exports){
var _ = require('underscore');
var Backbone = require('backbone');
...
},{"./PlanScreenTemplate":69,"./views/PlanScreenModuleView":94,"./views/PlanScreenRegimenView":96,"backbone":2,"underscore":3}],71:[function(require,module,exports){
module.exports = {
...
},{"./SideNavTemplatePatient":72,"backbone":2,"underscore":3}],74:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"./TopBarExpandedTemplate":74,"./TopBarExpandedWidgetButtonView":77,"backbone":2,"underscore":3}],76:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"./TopBarExpandedWidgetButtonTemplate":76,"backbone":2,"underscore":3}],78:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<div class=\"content-left\">\n  <div class=\"user\">\n    <img src=\"/media/doctor-portrait.png\" class=\"picture\">\n    <div class=\"info\">\n      <span class=\"title\">My Primary Physician</span>\n      <span class=\"name\">Dr. Julia Vitale</span>\n    </div>\n  </div>\n</div>\n<div class=\"content-middle\">\n  <div class=\"widget-button-contain\"></div>\n</div>\n<div class=\"content-right\">\n  <span class=\"widget-count\">0 widget</span>\n  <span class=\"button\" style=\"background-color: #fc7575;\">View Timeline</span>\n</div>\n";
  });
...
},{"./TopBarExpandedView":75,"./TopBarTemplatePatient":78,"./TopBarWidgetButtonView":81,"./WidgetModel":83,"backbone":2,"underscore":3}],80:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
...
},{"hbsfy/runtime":12}],81:[function(require,module,exports){
var _ = require('underscore');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"./TopBarWidgetButtonTemplate":80,"backbone":2,"underscore":3}],82:[function(require,module,exports){
var Backbone = require('backbone');
var WidgetModel = require('./WidgetModel');
...
},{"./WidgetModel":83,"backbone":2}],83:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./Prefixer":71,"./WidgetTemplate":84,"backbone":2,"underscore":3}],86:[function(require,module,exports){
var Backbone = require('backbone');
var _ = require('underscore');
...
},{"backbone":2,"underscore":3}],87:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"./TimelineModuleModel":88,"backbone":2}],88:[function(require,module,exports){
var Backbone = require('backbone');
...
},{"backbone":2}],89:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div class=\"module log-breakfast\" style=\"background-image: url('/media/timeline-bg/";
  if (helper = helpers.bgImage) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.bgImage); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "_BG.png')\">\n  <div class=\"unexpanded-widget slider-widget\">\n    <span class=\"title\">";
  ...
  buffer += escapeExpression(stack1)
    + "</span>\n    <div class=\"graphic-container\">\n      <div class=\"bar-graphic\">\n        <div class=\"data\"></div>\n      </div>\n      <span class=\"bar-graphic-text-left\">";
  if (helper = helpers.barTextLeft) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.barTextLeft); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n      <span class=\"bar-graphic-text-right\">";
  if (helper = helpers.barTextRight) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.barTextRight); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
  ...
  buffer += escapeExpression(stack1)
    + "\"></i>\n      <div class=\"status ";
  if (helper = helpers.colorClass) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.colorClass); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "\">\n        <span class=\"text\">";
...
},{"hbsfy/runtime":12}],90:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += escapeExpression(stack1)
    + "</span>\n    <div class=\"graphic-container\">\n      <span class=\"first-line-data\">";
  if (helper = helpers.firstLine) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.firstLine); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span><br>\n      <span class=\"second-line-data\">";
  if (helper = helpers.secondLine) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.secondLine); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n    </div>\n\n    <div class=\"bottom-bar\">\n      <i class=\"icon-filled ";
  if (helper = helpers.icon) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.icon); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
...
},{"hbsfy/runtime":12}],91:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  if (helper = helpers.firstLineLeft) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.firstLineLeft); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span><br>\n          <span class=\"second-line-data\">";
  if (helper = helpers.secondLineLeft) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.secondLineLeft); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n        </div>\n        <div class=\"data-right\">\n          <span class=\"first-line-data\">";
  if (helper = helpers.firstLineRight) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.firstLineRight); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span><br>\n          <span class=\"second-line-data\">";
  if (helper = helpers.secondLineRight) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.secondLineRight); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n        </div>\n      </div>\n    </div>\n\n    <div class=\"bottom-bar\">\n      <i class=\"icon-filled ";
  if (helper = helpers.icon) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.icon); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
...
},{"hbsfy/runtime":12}],92:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  return "<h1>Regimen Overview</h1>\n<div class=\"overview-container\">\n</div>";
  });

},{"hbsfy/runtime":12}],93:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<img src=\"../../media/overview/overview_";
  if (helper = helpers.overviewBG) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.overviewBG); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + ".jpg\">\n<h3 class=\"name\">";
  if (helper = helpers.name) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.name); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</h3>\n<h4 class=\"status\">";
  if (helper = helpers.overviewStatus) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.overviewStatus); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
  ...
  buffer += escapeExpression(stack1)
    + "</div>\n</div>\n<div class=\"data-cta\">\n  <div class=\"data-left\">\n    <span class=\"value\">";
  if (helper = helpers.leftValue) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.leftValue); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n    <span class=\"unit\">";
  if (helper = helpers.leftUnit) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.leftUnit); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n    <span class=\"average\">";
  if (helper = helpers.leftAvg) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.leftAvg); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n  </div>\n  <div class=\"data-right\">\n    <span class=\"value\">";
  if (helper = helpers.rightValue) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.rightValue); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n    <span class=\"unit\">";
  if (helper = helpers.rightUnit) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.rightUnit); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n    <span class=\"average\">";
  if (helper = helpers.rightAvg) { stack1 = helper.call(depth0, {hash:{},data:data}); }
  else { helper = (depth0 && depth0.rightAvg); stack1 = typeof helper === functionType ? helper.call(depth0, {hash:{},data:data}) : helper; }
  buffer += escapeExpression(stack1)
    + "</span>\n  </div>\n</div>";
  return buffer;
  });

},{"hbsfy/runtime":12}],94:[function(require,module,exports){
var _ = require('underscore');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"../templates/PlanScreenModuleTemplate1":89,"../templates/PlanScreenModuleTemplate2":90,"../templates/PlanScreenModuleTemplate3":91,"backbone":2,"underscore":3}],95:[function(require,module,exports){
var _ = require('underscore');
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"../templates/PlanScreenRegimenWidget":93,"backbone":2,"underscore":3}],96:[function(require,module,exports){
var Backbone = require('backbone');
Backbone.$ = $;
...
},{"../templates/PlanScreenRegimenContainer":92,"./PlanScreenRegimenOverviewView":95,"backbone":2}]},{},[1]);
